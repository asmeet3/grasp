...
class ChatManager:
    ...
    async def save_chat(self, user_id: str, chat_id: str, title: str, messages: list[dict], created_at: str | None = None) -> None:
        ...
        async with self.engine.begin() as conn:
            ...
            # Use on_conflict_do_update for PostgreSQL upsert
            set_dict = {
